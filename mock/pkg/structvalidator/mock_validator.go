...
//   - obj interface{}
func (_e *MockValidator_Expecter) Validate(obj interface{}) *MockValidator_Validate_Call {
	return &MockValidator_Validate_Call{Call: _e.mock.On("Validate", obj)}
}

func (_c *MockValidator_Validate_Call) Run(run func(obj interface{})) *MockValidator_Validate_Call {
